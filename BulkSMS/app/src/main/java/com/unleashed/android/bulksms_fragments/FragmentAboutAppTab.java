...
public class FragmentAboutAppTab extends PlaceholderFragment{
    ...
    public void onResume() {
        ...
        YoYo.with(Techniques.SlideInUp).duration(1500).playOn(imageView);
        YoYo.with(Techniques.SlideInUp).duration(1500).playOn(lbl_version_number);
        YoYo.with(Techniques.SlideInUp).duration(1500).playOn(lbl_version_history);
        YoYo.with(Techniques.SlideInUp).duration(1500).playOn(lbl_about_app);
    }
    ...
    private void initAboutAppTab(View localView) {
        ...
        imageView = (ImageView) localView.findViewById(R.id.imageView);
