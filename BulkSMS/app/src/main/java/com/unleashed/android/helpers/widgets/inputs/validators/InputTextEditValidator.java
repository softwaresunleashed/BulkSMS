...
public class InputTextEditValidator {
    ...
    private static final String SKYPE_PATTERN = "^[:A-Za-z0-9._-]+$";
    ...
    private static final String PHONE_PATTERN = "^[^0][0-9]+$"; // Don't allow no starting with 0 and non numeric char
//    private static final String PHONE_PATTERN = "^[0-9 \\-,\\+\\(\\)]+$";

    private static final String POSSIBLE_PHONE_NO = "[0-9]{10}";

    private static final String SPECIAL_CHARS = "[^A-Za-z0-9.,!? ]{4}";

    private static final String WITHOUT_SYMBOL_CHARS = "[^\\p{ASCII}]";
    ...
    private Pattern mPossiblePhonePattern;
    private Pattern mSpecialCharsPattern;
    private Pattern mWithoutSymbolCharsPattern;
    ...
    private boolean mDisallowPhone;
    private boolean mCheckSpecialChars;
    private boolean mAvoidSymbols;
    ...
    private String mDisallowPhoneValidationError;
    private String mCheckSpecialCharsValidationError;
    private String mAvoidSymbolsValidationError;
    ...
    public InputTextEditValidator(Builder builder) {
        ...
        mDisallowPhone = builder.mDisallowPhone;
        mCheckSpecialChars = builder.mCheckSpecialChars;
        mAvoidSymbols = builder.mAvoidSymbols;
        ...
        mDisallowPhoneValidationError = builder.mDisallowPhoneValidationError;
        mCheckSpecialCharsValidationError = builder.mCheckSpecialCharsValidationError;
        mAvoidSymbolsValidationError = builder.mAvoidSymbolsValidationError;
        ...
        mPossiblePhonePattern = Pattern.compile(POSSIBLE_PHONE_NO);
        mSpecialCharsPattern = Pattern.compile(SPECIAL_CHARS);
        mWithoutSymbolCharsPattern = Pattern.compile(WITHOUT_SYMBOL_CHARS);
    }
...
//            }
            ...
            if (mDisallowPhone) {
                Matcher matcher = mPossiblePhonePattern.matcher(value);
                if (matcher.find()) {
                    throw new ValidationException(mDisallowPhoneValidationError);
                }
            }

            if (mCheckSpecialChars) {
                Matcher matcher = mSpecialCharsPattern.matcher(value);
                if (matcher.find()) {
                    throw new ValidationException(mCheckSpecialCharsValidationError);
                }
            }

            if (mAvoidSymbols) {
                Matcher matcher = mWithoutSymbolCharsPattern.matcher(value);
                if (matcher.find()) {
                    throw new ValidationException(mAvoidSymbolsValidationError);
                }
            }
            ...
            if (mUppercaseCheck) {
                ...
                for (char c : value.toCharArray()) {
                    ...
                    if ((double) upperCaseCount / value.length() > 0.5) {
    ...
    public static class Builder {
        ...
        public Builder withDisallowPhone(String error) {
            mDisallowPhone = true;
            mDisallowPhoneValidationError = error;
            return this;
        }

        public Builder withCheckSpecialChars(String error) {
            mCheckSpecialChars = true;
            mCheckSpecialCharsValidationError = error;
            return this;
        }

        public Builder withAvoidSymbolChars(String error) {
            mAvoidSymbols = true;
            mAvoidSymbolsValidationError = error;
            return this;
        }
